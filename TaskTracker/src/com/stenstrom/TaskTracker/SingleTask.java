		...
		try {
			...
			if (extras != null) {
				...
				if (isCollab.equals("1")) {
					...
					dbConn.execute().get();
					((TextView) findViewById(R.id.single_task_TV_shared_text))
					...
					// t.setText("these are the collaborators: " +
					// collaborators);
					// LinearLayout singleView = (LinearLayout)
					// findViewById(R.id.single_task);
